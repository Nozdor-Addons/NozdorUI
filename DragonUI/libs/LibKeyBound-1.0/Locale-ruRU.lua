...
LibKeyBoundLocale10 = {
	REVISION = REVISION;
	BindingMode = "Режим привязки клавиш";
	...
	CannotResetInCombat = 'Невозможно сбросить привязки клавиш в бою';
	ResetKeybinds = 'Сбросить привязки';
	ResetKeybindsConfirm = 'ВНИМАНИЕ: Это сбросит ВСЕ привязки клавиш (включая установленные через стандартный интерфейс) на значения по умолчанию для текущего набора привязок. Продолжить?';
	ResetKeybindsSuccess = 'Все привязки клавиш сброшены на значения по умолчанию.';
